...
const I18N = {
  en: {
    ...
    dfm: 'Design for Manufacture (DFM)',
    cat_3d_model: '3D Model',
    cat_prototype: 'Prototype',
    cat_case_study: 'Case Study',
    cat_motion_animation: 'Motion & Animation',
    cat_photography: 'Photography',
    cat_illustration: 'Illustration',
    cat_vfx: 'VFX',
    cat_game_art: 'Game Art',
    image: 'Image',
    title: 'Title',
    artist: 'Artist',
  ...
  ru: {
    ...
    dfm: 'Дизайн для производства (DFM)',
    cat_3d_model: '3D Модель',
    cat_prototype: 'Прототип',
    cat_case_study: 'Case Study',
    cat_motion_animation: 'Моушн и Анимация',
    cat_photography: 'Фотография',
    cat_illustration: 'Иллюстрация',
    cat_vfx: 'Визуальные эффекты (VFX)',
    cat_game_art: 'Игровой арт',
    image: 'Изображение',
    title: 'Название',
    artist: 'Автор',
  ...
  kk: {
    ...
    'ui-ux-design': 'UI/UX дизайн',
    dfm: 'Өндіріс технологиясының дизайны (DFM)',
    cat_3d_model: '3D модельдеу',
    cat_prototype: 'Прототип',
    cat_case_study: 'Case Study',
    cat_motion_animation: 'Моушн және Анимация',
    cat_photography: 'Фотография',
    cat_illustration: 'Иллюстрация',
    cat_vfx: 'Визуалды эффектілер (VFX)',
    cat_game_art: 'Ойын өнері',
    image: 'Сурет',
    title: 'Атауы',
    artist: 'Автор',
    categoryLabel: 'Санат',
...
async function apiFetch(path, opts = {}) {
  ...
  // Only add Bearer token if it's not already provided in opts.headers
